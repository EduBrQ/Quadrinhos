<html lang="en" class=""><head><script src="//static.codepen.io/assets/editor/live/console_runner-ce3034e6bde3912cc25f83cccb7caa2b0f976196f2f2d52303a462c826d54a73.js"></script><script src="//static.codepen.io/assets/editor/live/css_live_reload_init-890dc39bb89183d4642d58b1ae5376a0193342f9aed88ea04330dc14c8d52f55.js"></script><meta charset="UTF-8"><meta name="robots" content="noindex"><link rel="shortcut icon" type="image/x-icon" href="//static.codepen.io/assets/favicon/favicon-8ea04875e70c4b0bb41da869e81236e54394d63638a1ef12fa558a4a835f1164.ico"><link rel="mask-icon" type="" href="//static.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111"><link rel="canonical" href="https://codepen.io/emoreno911/pen/yXvZxd">
    ...
    <style class="cp-pen-styles">:root {
        ...
        .RESERVAR .seat.aisle-right {
            margin-right: 10px;
        }

        .RESERVAR .seat.aisle-left {
            margin-left: 10px;
        }

        .RESERVAR .seat.aisle-top {
            margin-top: 10px;
        }

        .RESERVAR .total button {
            border: none;
            border-radius: 2px;
            color: #fff;
        ...
        .RESERVAR .seat.Indisponível,
        .RESERVAR .legend li:last-child:after {
            background-color: #666;
        }

        .RESERVAR .seat.selected {
        ...
        .page2 .RESERVAR .sinopsis {
            transform: translateX(0);
            opacity: 1;
        }

        .page2 .RESERVAR section {
            transform: translateX(0);
            opacity: 1;
        }

        .page2 .RESERVAR .total {
            transform: translateY(0);
            opacity: 1;
        }
        ...
        <div class="main">
                ...
                <div class="content">
                    <ul class="covers loaded">
                        ...
                        <li data-index="3">
                            ...
                            <span>Transformers: O Ultimo Cavaleiro</span>
                        </li>
                        ...
                        <li data-index="5">
                            ...
                            <span>Piratas do Caribe 6</span><small>16:00 (2h 15m)</small>
                        </li>
                        ...
                        <li data-index="6">
                            ...
                            <span>Guardiões da Galáxia</span><small>16:00 (2h 15m)</small>
                        </li>
                        ...
                        <li data-index="7">
                            ...
                            <span>Kong: Ilha da Caveira</span><small>16:00 (2h 15m)</small>
                        </li>
                        ...
                        <li data-index="19">
                            ...
                            <span>Guardiões da Galáxia Vol. 2</span><small>16:00 (2h 15m)</small>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="RESERVAR">
                <div class="sinopsis">
                    ...
                    <p>Uma princesa amazôna chega ao mundo dos homem para se tornar o maior dos super-heróis do sexo feminino.</p>
                    <span>Ainda não assistiu</span>
                    <small>Disponível no Cinema Local às 16:00 - Duração: (2h 15m)</small>
                </div>
                <section>
                    <ul class="legend">
                        <li>Disponíveis</li>
                    ...
                    <span>Selecione seus lugares</span>
                    <div class="seats"><div class="seat Indisponível ">A1</div><div class="seat  aisle-right">A2</div><div class="seat  ">A3</div><div class="seat  ">A4</div><div class="seat  ">A5</div><div class="seat  ">A6</div><div class="seat Indisponível ">A7</div><div class="seat Indisponível aisle-left">A8</div><div class="seat  ">A9</div><div class="seat  ">B1</div><div class="seat  aisle-right">B2</div><div class="seat  ">B3</div><div class="seat Indisponível ">B4</div><div class="seat  ">B5</div><div class="seat Indisponível ">B6</div><div class="seat  ">B7</div><div class="seat  aisle-left">B8</div><div class="seat  ">B9</div><div class="seat Indisponível ">C1</div><div class="seat  aisle-right">C2</div><div class="seat  ">C3</div><div class="seat Indisponível ">C4</div><div class="seat  ">C5</div><div class="seat  ">C6</div><div class="seat Indisponível ">C7</div><div class="seat  aisle-left">C8</div><div class="seat  ">C9</div><div class="seat  ">D1</div><div class="seat Indisponível aisle-right">D2</div><div class="seat  ">D3</div><div class="seat Indisponível ">D4</div><div class="seat  ">D5</div><div class="seat  ">D6</div><div class="seat  ">D7</div><div class="seat  aisle-left">D8</div><div class="seat Indisponível ">D9</div><div class="seat Indisponível ">E1</div><div class="seat  aisle-right">E2</div><div class="seat  ">E3</div><div class="seat  ">E4</div><div class="seat  ">E5</div><div class="seat  ">E6</div><div class="seat Indisponível ">E7</div><div class="seat  aisle-left">E8</div><div class="seat  ">E9</div><div class="seat  ">F1</div><div class="seat  aisle-right">F2</div><div class="seat  ">F3</div><div class="seat Indisponível ">F4</div><div class="seat Indisponível ">F5</div><div class="seat  ">F6</div><div class="seat  ">F7</div><div class="seat  aisle-left">F8</div><div class="seat  ">F9</div><div class="seat Indisponível ">G1</div><div class="seat  aisle-right">G2</div><div class="seat Indisponível ">G3</div><div class="seat  ">G4</div><div class="seat  ">G5</div><div class="seat  ">G6</div><div class="seat Indisponível ">G7</div><div class="seat  aisle-left">G8</div><div class="seat  ">G9</div><div class="seat Indisponível ">H1</div><div class="seat  aisle-right">H2</div><div class="seat  ">H3</div><div class="seat Indisponível ">H4</div><div class="seat  ">H5</div><div class="seat  ">H6</div><div class="seat  ">H7</div><div class="seat Indisponível aisle-left">H8</div><div class="seat  ">H9</div><div class="seat Indisponível aisle-top">I1</div><div class="seat  aisle-top">I2</div><div class="seat  aisle-top">I3</div><div class="seat  aisle-top">I4</div><div class="seat  aisle-top">I5</div><div class="seat Indisponível aisle-top">I6</div></div>
...
<script>// press f11 to full page view
    // vote for me at https://www.uplabs.com/posts/fluent-movie-RESERVANDO
    ...
    $('button.back').on('click', function (evt) {
        ...
        $('.total button').removeClass('success').text('RESERVAR');
        tooglePage1();
    });
    ...
    for (var i = 0; i < 78; i++) {if (window.CP.shouldStopExecution(1)){break;}
        ...
        var Indisponível = i % 7 == 0 || i % 6 == 0 ? 'Indisponível' : '';

        var aisle = i % 9 === 1 ? 'aisle-right' : i % 9 === 7 ? 'aisle-left' : '';

        if (row === 'I') aisle = 'aisle-top';

        seats.push('<div class="seat ' + Indisponível + ' ' + aisle + '">' + row + (i % 9 + 1) + '</div>');
    }
    ...
    $('.total button').on('click', function (evt) {
        ...
        if (!$button.hasClass('success') && total !== '$0') {
            ...
            setTimeout(function () {
                $loader.hide();
                $button.html('<i class="zmdi zmdi-check-circle"></i> RESERVADO!');
